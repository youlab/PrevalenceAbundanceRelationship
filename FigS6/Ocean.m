...
GeneName=Name;
GeneAbundance=SampleOcean;
clear Name;
clear SampleAll;
TxtFile=fileread('D:\GeneCorrelationAnalysis\TaraOcean\RawData\KEGGMapper_Brite.txt');
...
saveas(gcf,'OceanAMR.fig');
saveas(gcf,'OceanAMR.pdf');
...
figure(2);
 ...
 ylabel('\chi values in the subsampling','fontsize',14);
 set(gcf,'position',[100 100 250 250]);
saveas(gcf,'OceanPhoto.fig');
saveas(gcf,'OceanPhoto.pdf');