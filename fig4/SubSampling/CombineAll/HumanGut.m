clear;
clc;
load('D:\GeneCorrelationAnalysis\Human\RawData\RawDataGene.mat');
Data0=SampleHuman;
...
C=linspecer(7);
errorbar(NNs,mean(Slope,2),std(Slope,0,2),'o-','markersize',10,'linewidth',1,'capsize',0,'color',C(2,:));hold on;
