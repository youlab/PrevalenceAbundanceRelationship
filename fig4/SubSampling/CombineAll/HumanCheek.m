clear;
clc;
load('D:\GeneCorrelationAnalysis\HumanSkin\RawData\RawDataGeneCheek.mat');
...
C=linspecer(7);
errorbar(NNs,mean(Slope,2),std(Slope,0,2),'o-','markersize',10,'linewidth',1,'capsize',0,'color',C(4,:));hold on;
