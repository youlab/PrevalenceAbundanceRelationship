clear;
clc;
load('D:\GeneCorrelationAnalysis\Mouse\RawData\RawDataGene.mat');
Data0=SampleMouse;
...
C=linspecer(7);
errorbar(NNs,mean(Slope,2),std(Slope,0,2),'o-','markersize',10,'linewidth',1,'capsize',0,'color',C(6,:));hold on;
