clear;
clc;
load('D:\GeneCorrelationAnalysis\macac\RawData\RawDataGene.mat');
Data0=SampleMacac;
...
C=linspecer(7);
errorbar(NNs,mean(Slope,2),std(Slope,0,2),'o-','markersize',10,'linewidth',1,'capsize',0,'color',C(7,:));hold on;
